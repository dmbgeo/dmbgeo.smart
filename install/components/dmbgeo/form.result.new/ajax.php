...
try
{
	$template = $signer->unsign($request->get('template') ?: '', 'form.result.new') ?: '.default';
	$paramString = $signer->unsign($request->get('parameters') ?: '', 'form.result.new');
}
